...
const DICTIONARY: Record<string, Omit<WordGrammarInfo, "word" | "cleanWord">> = {
  ...
  apply: {
    translation: "aplicar / postular",
    partOfSpeech: "Verbo regular",
    phonetic: "/əˈplaɪ/",
    past: { form: "applied", exampleEn: "He applied the rules yesterday.", exampleEs: "Él aplicó las reglas ayer." },
    present: { form: "apply / applies", exampleEn: "Officers apply the standard daily.", exampleEs: "Los oficiales aplican la norma a diario." },
    future: { form: "will apply", exampleEn: "We will apply the protocol tomorrow.", exampleEs: "Aplicaremos el protocolo mañana." },
  },
  applied: {
    translation: "aplicó / aplicado",
    partOfSpeech: "Verbo (Pasado)",
    phonetic: "/əˈplaɪd/",
    past: { form: "applied", exampleEn: "The crew applied the brakes on landing.", exampleEs: "La tripulación aplicó los frenos al aterrizar." },
    present: { form: "apply / applies", exampleEn: "They apply standard procedures.", exampleEs: "Ellos aplican procedimientos estándar." },
    future: { form: "will apply", exampleEn: "They will apply instructions tomorrow.", exampleEs: "Ellos aplicarán las instrucciones mañana." },
  },
  applying: {
    translation: "aplicando",
    partOfSpeech: "Verbo (-ing)",
    phonetic: "/əˈplaɪ.ɪŋ/",
    past: { form: "was applying", exampleEn: "He was applying pressure to the lever.", exampleEs: "Él estaba aplicando presión a la palanca." },
    present: { form: "is applying", exampleEn: "The team is applying the checklist now.", exampleEs: "El equipo está aplicando la lista ahora." },
    future: { form: "will be applying", exampleEn: "They will be applying updates soon.", exampleEs: "Estarán aplicando actualizaciones pronto." },
  },
  application: {
    translation: "aplicación / solicitud",
    partOfSpeech: "Sustantivo",
    phonetic: "/ˌæp.lɪˈkeɪ.ʃən/",
    past: { form: "application", exampleEn: "The application was submitted yesterday.", exampleEs: "La solicitud fue enviada ayer." },
    present: { form: "application", exampleEn: "The application is currently active.", exampleEs: "La aplicación está activa actualmente." },
    future: { form: "application", exampleEn: "The application will be approved tomorrow.", exampleEs: "La solicitud será aprobada mañana." },
  },
  practice: {
    translation: "practicar / práctica",
    partOfSpeech: "Verbo / Sustantivo",
    phonetic: "/ˈpræk.tɪs/",
    past: { form: "practiced", exampleEn: "We practiced radio calls yesterday.", exampleEs: "Practicamos llamadas de radio ayer." },
    present: { form: "practice", exampleEn: "I practice ALCPT questions daily.", exampleEs: "Practico preguntas ALCPT a diario." },
    future: { form: "will practice", exampleEn: "We will practice again tomorrow.", exampleEs: "Practicaremos de nuevo mañana." },
  },
  be: {
...
const VOCABULARY_TRANSLATIONS: Record<string, string> = {
  ...
  rank: "rango / grado",
  apply: "aplicar",
  applied: "aplicó / aplicado",
  applying: "aplicando",
  application: "aplicación / solicitud",
  practice: "practicar",
  practiced: "practicó / practicado",
  practicing: "practicando",
  check: "verificar / revisar",
  checked: "verificó / revisó",
  checking: "verificando / revisando",
  ask: "preguntar / pedir",
  asked: "preguntó / pidió",
  asking: "preguntando",
  listen: "escuchar",
  listened: "escuchó",
  listening: "escuchando / audición",
  read: "leer",
  ...
  needing: "necesitando",
  want: "querer / desear",
  wanted: "quiso / deseado",
  wanting: "queriendo",
  like: "gustar / como",
  liked: "gustó",
  liking: "gustando",
  work: "trabajar / funcionar / trabajo",
  worked: "trabajó / funcionó",
  working: "trabajando / en funcionamiento",
  start: "empezar / iniciar",
  started: "empezó / iniciado",
  starting: "iniciando",
  stop: "detener / parar",
  stopped: "detuvo / detenido",
  stopping: "deteniendo",
  complete: "completar / completo",
  completed: "completó / completado",
  completing: "completando",
  continue: "continuar",
  continued: "continuó / continuado",
  continuing: "continuando",
  follow: "seguir",
  followed: "siguió / seguido",
  following: "siguiente / siguiendo",
  understand: "comprender / entender",
  understood: "comprendió / entendido",
  understanding: "comprensión / entendiendo",
  remember: "recordar",
  remembered: "recordó",
  ...
  explain: "explicar",
  explained: "explicó / explicado",
  explaining: "explicando",
  explanation: "explicación",
  call: "llamar / llamada",
  called: "llamó / llamado",
  calling: "llamando",
  turn: "girar / turno",
  turned: "giró",
  turning: "girando",
  move: "mover / trasladar",
  moved: "movió / trasladado",
  moving: "moviendo",
  movement: "movimiento",
  live: "vivir",
  lived: "vivió",
  ...
  arriving: "llegando",
  arrival: "llegada",
  depart: "partir / despegar",
  departed: "partió / despegó",
  departing: "partiendo",
  ...
  open: "abrir / abierto",
  opened: "abrió",
  opening: "abriendo / apertura",
  close: "cerrar / cerca",
  closed: "cerró / cerrado",
  closing: "cerrando",
  flying: "volando / vuelo",
  flight: "vuelo",
  land: "aterrizar / tierra",
  landed: "aterrizó",
  landing: "aterrizando / aterrizaje",
  takeoff: "despegue",
  airplane: "avión",
  plane: "avión",
  aircraft: "aeronave",
  ...
  prepare: "preparar",
  prepared: "preparó / preparado",
  preparing: "preparando",
  preparation: "preparación",
  operate: "operar / manejar",
  operated: "operó / manejado",
  operating: "operando",
  operation: "operación",
  operations: "operaciones",
  maintain: "mantener",
  maintained: "mantuvo / mantenido",
  maintaining: "manteniendo",
  maintenance: "mantenimiento",
  inspect: "inspeccionar",
  inspected: "inspeccionó / inspeccionado",
  inspecting: "inspeccionando",
  inspection: "inspección",
  report: "informar / reporte",
  reported: "informó / reportado",
  reporting: "informando",
  reports: "informes / reportes",
  confirm: "confirmar",
  confirmed: "confirmó / confirmado",
  confirming: "confirmando",
  cancel: "cancelar",
  cancelled: "canceló / cancelado",
  canceling: "cancelando",

  // VOCABULARIO TÁCTICO, AVIACIÓN Y MILITAR
  air: "aire / aéreo",
  airfield: "aeródromo / pista",
  jet: "avión a reacción / reactor",
  ...
  leader: "líder",
  squad: "escuadra / pelotón",
  unit: "unidad",
  units: "unidades",
  convoy: "convoy / columna",
  camp: "campamento",
  airbase: "base aérea",
  station: "estación / puesto",
  depot: "depósito / almacén",
  runway: "pista de aterrizaje",
  tarmac: "plataforma / pista",
  terminal: "terminal",
  gate: "puerta / portón",
  motor: "motor",
  pool: "parque automotor / reserva",
  sector: "sector",
  fort: "fuerte militar",
  liberty: "libertad / base Liberty",
  pendleton: "Pendleton",
  naval: "naval / de la armada",
  sea: "mar",
  ground: "tierra / suelo",
  field: "campo / terreno",
  floor: "piso / suelo",
  ...
  // METEOROLOGÍA Y CLIMA (ALCPT LISTENING & READING)
  ...
  forecast: "pronóstico",
  light: "ligero / luz",
  severe: "severo / intenso",
  heavy: "fuerte / pesado",

  // NAVEGACIÓN, VELOCIDAD Y ALTITUD
  height: "altura",
  level: "nivel",
  bearing: "orientación / rumbo",
  degrees_nav: "grados de rumbo",
  turns: "gira",
  climb: "ascender / subir",
  climbs: "asciende",
  climbing: "ascendiendo / subiendo",
  descend: "descender / bajar",
  descends: "desciende",
  descending: "descendiendo / bajando",
  meters: "metros",
  distance: "distancia",
  divert: "desviar",
  diverted: "desvió / desviado",
  diverting: "desviando",

  // SISTEMAS, MECÁNICA Y ELECTRICIDAD
  engines: "motores",
  turbine: "turbina",
  turbines: "turbinas",
  rotor: "rotor",
  ...
  circuit: "circuito",
  circuits: "circuitos",
  breaker: "disyuntor / interruptor",
  breakers: "disyuntores",
  ...
  fault: "falla / avería",
  faults: "fallas",
  failure: "fallo / desperfecto",
  failures: "fallos",
  intermittent: "intermitente",
  detect: "detectar",
  detected: "detectó / detectado",
  detecting: "detectando",
  detection: "detección",
  exhibit: "mostrar / presentar",
  exhibited: "mostró / exhibió",
  exhibiting: "mostrando",
  fuel: "combustible",
  bladders: "vejigas / tanques de combustible",
  tank: "tanque",
  tanks: "tanques",
  oil: "aceite",
  ...
  wire: "cable",
  wires: "cables",
  backup: "respaldo / auxiliar",
  damaged: "dañado / averiado",
  damage: "daño",
  broken: "roto / quebrado",
  leak: "fuga / escape",
  leaking: "goteando / con fuga",
  ...
  risk: "riesgo",
  risks: "riesgos",
  peril: "peligro extremo",
  jeopardy: "peligro / riesgo",
  safety: "seguridad",
  prevention: "prevención",
  prevent: "prevenir",
  prevented: "previno / prevenido",

  // PROCEDIMIENTOS, ÓRDENES Y NORMAS
  mandatory: "obligatorio",
  obligatory: "obligatorio",
  compulsory: "obligatorio / forzoso",
  voluntary: "voluntario",
  elective: "optativo / electivo",
  obligation: "obligación",
  require: "requerir",
  requires: "requiere",
  required: "requirió / requerido",
  requirement: "requisito",
  requirements: "requisitos",
  instruct: "instruir / ordenar",
  instructs: "instruye",
  instructed: "instruyó / instruido",
  instruction: "instrucción",
  demand: "exigir / demandar",
  demanded: "exigió / demandado",
  order: "orden / ordenar",
  ordered: "ordenó / ordenado",
  briefing: "reunión informativa / informe",
  announcement: "anuncio / aviso",
  lecture: "charla / conferencia",
  assembly: "asamblea / reunión",
  assemble: "reunirse / ensamblar",
  assembled: "se reunió / reunido",
  assembles: "se reúne",
  attendance: "asistencia / concurrencia",
  schedule: "horario / programar",
  schedules: "horarios / programa",
  scheduled: "programó / programado",
  delays: "retrasos",
  delayed: "retrasó / demorado",
  delaying: "retrasando",
  canceled: "canceló / cancelado",
  caused: "causó / provocado",
  cause: "causa / provocar",
  carrying: "transportando / llevando",
  carry: "llevar / transportar",
  carries: "lleva",
  stow: "guardar / estibar",
  stowed: "guardó / guardado",
  stowing: "guardando",
  stowage: "almacenamiento / estiba",
  supply: "suministro / abastecer",
  ...
  submitted: "entregó / enviado",
  submitting: "entregando",
  clipboard: "tabla portapapeles",
  badge: "placa / distintivo",
  identification: "identificación",
  ticket: "boleto / papeleta",
  warranty: "garantía",
  ...
  // PREGUNTAS Y TÉRMINOS DE EXAMEN ALCPT
  questions: "preguntas",
  items: "reactivos / ítems",
  answers: "respuestas",
  option: "opción / alternativa",
  options: "opciones / alternativas",
  choice: "elección / opción",
  chosen: "elegido / seleccionado",
  select: "seleccionar",
  selected: "seleccionó / seleccionado",
  choose: "elegir",
  synonym: "sinónimo",
  antonym: "antónimo / opuesto",
  opposite: "opuesto / contrario",
  ...
  indicate: "indicar",
  indicates: "indica",
  indicated: "indicó / indicado",
  dialogue: "diálogo",
  speaker: "locutor / hablante",
  audio: "audio",
  examination: "examen / evaluación",
  test: "prueba / examen",
  formal: "formal",
  passive: "pasivo (voz pasiva)",
  ...
  threat: "amenaza",
  suggested: "sugirió / sugerido",
  suggest: "sugerir",
  ought: "debería (ought to)",
  had: "había / tuvo",
  has: "tiene / ha",
  been: "sido / estado",
  did: "hizo (auxiliar pasado)",
  will: "hará (auxiliar futuro)",
  data: "datos / información",
  display: "pantalla / mostrar",
  dispatch: "despachar / envío",
  prompt: "consigna / indicación",
  prompts: "consignas",
  alternate: "alternativo / alternar",
  alternates: "alterna",
  annual: "anual / de cada año",
  checklist: "lista de verificación / control",
  condition: "condición / estado",
  conditions: "condiciones / estado meteorológico",
  equipment: "equipo / equipamiento militar",
  indirect: "indirecto",
  infinitive: "infinitivo",
  main: "principal / central",
  math: "matemáticas",
  newly: "recientemente / recién",
  official: "oficial / reglamentario",
  part: "parte / repuesto / sección",
  parts: "partes / repuestos",
  private: "soldado raso / privado",
  replace: "reemplazar / sustituir",
  replaced: "reemplazó / reemplazado",
  replaces: "reemplaza",
  replacing: "reemplazando",
  reserve: "reserva militar / reservar",
  serious: "grave / serio",
  so: "así que / tan",
  specify: "especificar / detallar",
  specified: "especificó / especificado",
  specifies: "especifica",
  technician: "técnico / especialista en mantenimiento",
  ...
  vary: "variar / cambiar",
  varies: "varía",
  varied: "varió / variado",
  years: "años",
  candidate: "candidato / postulante",
...
export function getWordGrammarInfo(rawWord: string): WordGrammarInfo {
    ...
    if (clean === irr.past || clean === irr.pp) {
      ...
      return {
        ...
        past: {
          ...
          exampleEs: `Ayer, ellos realizaron (${irr.past} - ${trans}) según las órdenes.`,
        },
        present: {
          form: `${baseVerb} / ${baseVerb}s`,
          exampleEn: `Today, personnel ${baseVerb} under standard protocol.`,
          exampleEs: `Hoy, se aplica (${baseVerb} - ${trans}) bajo el protocolo estándar.`,
        },
        future: {
          form: `will ${baseVerb}`,
  ...
  if (clean.endsWith("ed") && clean.length > 3) {
    ...
    const baseTrans = VOCABULARY_TRANSLATIONS[base];
    const transGuess = directTrans || baseTrans || base;
    return {
      word: rawWord,
      cleanWord: clean,
      ...
      past: {
        form: clean,
        exampleEn: `The team ${clean} the instructions yesterday.`,
        exampleEs: `El equipo completó (${clean}) ayer.`,
      },
      present: {
        form: `${base} / ${base}s`,
        exampleEn: `Personnel ${base} the procedures daily.`,
        exampleEs: `El personal utiliza (${base}) diariamente.`,
      },
      future: {
        form: `will ${base}`,
        exampleEn: `The team will ${base} all requirements tomorrow.`,
        exampleEs: `El equipo realizará (${base}) mañana.`,
      },
    };
  }
  ...
  if (clean.endsWith("ing") && clean.length > 4) {
    ...
    if (clean.endsWith("ying")) base = clean.slice(0, -4) + "ie";
    const baseTrans = VOCABULARY_TRANSLATIONS[base];
    const transGuess = directTrans || baseTrans || clean;
    return {
      word: rawWord,
      cleanWord: clean,
      translation: transGuess,
      ...
      past: {
        form: `was/were ${clean}`,
        exampleEn: `The unit was ${clean} when the signal arrived.`,
        exampleEs: `La unidad estaba (${clean}) cuando llegó la señal.`,
      },
      present: {
        form: `is/are ${clean} / ${base}`,
        exampleEn: `Currently, the aircraft is ${clean}.`,
        exampleEs: `Actualmente, la aeronave está (${clean}).`,
      },
      future: {
        form: `will be ${clean}`,
        exampleEn: `The team will be ${clean} tomorrow.`,
        exampleEs: `El equipo estará (${clean}) mañana.`,
      },
    };
  }
  ...
  if (clean.endsWith("ly") && clean.length > 3) {
    ...
    const rootTrans = VOCABULARY_TRANSLATIONS[root];
    const transGuess = directTrans || (rootTrans ? `${rootTrans}mente` : clean);
    return {
      word: rawWord,
      cleanWord: clean,
      translation: transGuess,
      ...
      past: {
        ...
        exampleEs: `El sistema operó (${clean}) en pruebas pasadas.`,
      },
      present: {
        form: clean,
        exampleEn: `Instruments function ${clean} in current conditions.`,
        exampleEs: `Los instrumentos funcionan (${clean}) actualmente.`,
      },
      future: {
        form: clean,
        exampleEn: `The procedure will execute ${clean} in future tests.`,
        exampleEs: `El procedimiento se ejecutará (${clean}) en futuras pruebas.`,
      },
    };
  }

  // Plurales regulares (-s, -es, -ies)
  if (clean.endsWith("s") && clean.length > 3) {
    ...
    if (singular) {
      const singTrans = VOCABULARY_TRANSLATIONS[singular] || DICTIONARY[singular]?.translation;
      if (singTrans) {
        return {
          word: rawWord,
          cleanWord: clean,
          translation: `${singTrans} (plural)`,
          partOfSpeech: "Sustantivo (Plural)",
          past: {
            form: `en pasado (${singular})`,
            exampleEn: `Records documented several ${clean} in earlier reports.`,
            exampleEs: `Los registros documentaron varios/as (${singTrans}) en informes anteriores.`,
          },
          present: {
            form: `en presente (${clean})`,
            exampleEn: `The unit inspects the ${clean} regularly.`,
            exampleEs: `La unidad inspecciona los/las (${singTrans}) con regularidad.`,
          },
          future: {
            form: `en futuro (${clean})`,
            exampleEn: `We will evaluate all ${clean} tomorrow.`,
            exampleEs: `Evaluaremos todos/as los/las (${singTrans}) mañana.`,
          },
        };
      }
    }
  ...
  // Si no se encuentra en el léxico, consultar caché dinámico de traducción
  let dynTrans = "";
  if (typeof window !== "undefined") {
    dynTrans = localStorage.getItem(`conango_trans_${clean}`) || "";
  }

  const generalTrans = directTrans || dynTrans || clean;
  return {
    word: rawWord,
    cleanWord: clean,
    translation: generalTrans,
    partOfSpeech: "Vocabulario",
    past: {
    ...
    future: {
      ...
      exampleEs: `Verás "${clean}" en futuros exámenes de la USAF.`,
    },
  };
}

// Servicio de traducción dinámica asíncrona para palabras fuera de vocabulario
export async function fetchWordTranslationAsync(rawWord: string): Promise<string | null> {
  const clean = sanitizeWord(rawWord);
  if (!clean || clean.length < 2) return null;

  if (VOCABULARY_TRANSLATIONS[clean]) return VOCABULARY_TRANSLATIONS[clean];
  if (DICTIONARY[clean]) return DICTIONARY[clean].translation;

  if (typeof window !== "undefined") {
    const cached = localStorage.getItem(`conango_trans_${clean}`);
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (translation && translation.toLowerCase() !== clean) {
        if (typeof window !== "undefined") {
          localStorage.setItem(`conango_trans_${clean}`, translation.toLowerCase());
        }
        return translation.toLowerCase();
      }
    }
  } catch (err) {
    // Si la red falla o tiene timeout, continúa silenciosamente
  }
  return null;
}
