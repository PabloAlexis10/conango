    ...
    <>
      <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-white rounded-3xl border-4 border-amber-300 shadow-2xl max-w-sm w-full p-6 text-center relative overflow-hidden"
        >
          <button
            type="button"
            onClick={onClose}
          ...
          <p className="text-xs text-[#A67B5B] font-semibold mt-1 mb-5">
            Duplica todos los puntos de experiencia que ganes durante los próximos 15 minutos y asciende de rango militar más rápido.
          </p>
