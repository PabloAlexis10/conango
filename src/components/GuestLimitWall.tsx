...
export default function GuestLimitWall({
  ...
  return (
    <div
      className={`bg-white rounded-3xl border-2 border-[#A67B5B] shadow-conan-card p-6 sm:p-10 text-center max-w-lg mx-auto ${className}`}
    >
      <div className="flex justify-center mb-3">
        <ConanMascot size="lg" mood="thinking" animate={true} />
      </div>

      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-100 border border-amber-300 text-amber-900 text-xs font-black uppercase tracking-wider mb-3">
        <Shield className="w-3.5 h-3.5 text-[#F59E0B]" />
        <span>Límite de Prueba Alcanzado (2 de 2)</span>
      </div>

      <h2 className="text-2xl sm:text-3xl font-black text-[#6B4423] tracking-tight mb-2">
        ¡Has completado tus lecciones gratuitas! 🐾
      </h2>

      <p className="text-xs sm:text-sm text-[#A67B5B] font-semibold leading-relaxed mb-6">
        Has aprovechado al máximo tus 2 lecciones de prueba como invitado. Para continuar practicando con las <strong className="text-[#6B4423]">100 fórmulas oficiales</strong>, audios en inglés 🇺🇸, vocabulario interactivo y guardar tus notas, inicia sesión o crea tu cuenta gratis.
      </p>

      {/* Benefits checklist */}
      <div className="bg-[#FAF6F0] p-4 rounded-2xl border border-[#E5D5C5] text-left space-y-2 mb-6 text-xs text-[#6B4423] font-bold">
